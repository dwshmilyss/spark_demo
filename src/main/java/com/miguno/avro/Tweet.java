...
public class Tweet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -745197176365160112L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Tweet\",\"namespace\":\"com.miguno.avro\",\"doc\":\"A basic schema for storing Twitter messages\",\"fields\":[{\"name\":\"username\",\"type\":\"string\",\"doc\":\"Name of the user account on Twitter.com\"},{\"name\":\"text\",\"type\":\"string\",\"doc\":\"The content of the user's Twitter message\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"Unix epoch time in seconds\"}]}");
   ...
   */
  public static com.miguno.avro.Tweet.Builder newBuilder() {
    return new com.miguno.avro.Tweet.Builder();
  }
   ...
   * @return A new Tweet RecordBuilder
   */
  public static com.miguno.avro.Tweet.Builder newBuilder(com.miguno.avro.Tweet.Builder other) {
    return new com.miguno.avro.Tweet.Builder(other);
  }
   ...
   * @return A new Tweet RecordBuilder
   */
  public static com.miguno.avro.Tweet.Builder newBuilder(com.miguno.avro.Tweet other) {
    return new com.miguno.avro.Tweet.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tweet>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.miguno.avro.Tweet.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.miguno.avro.Tweet other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.Tweet.Builder clearTimestamp() {
